...
//			SetFontMeiryo((Control)form, point);
		...
		/// 読み込みに成功した場合はnullを返す。
		/// </summary>
		/// <param name="ass">アセンブリ名</param>
		/// <param name="error_ass">読み込みに失敗したアセンブリ</param>
		...
		//-------------------------------------------------------------------------
		/// <summary>
		/// ListViewのtooltipをSubItems毎に設定する。
		/// </summary>
		/// <remarks>
		/// <para>ListViewのtooltipをSubItems毎に設定する。</para>
		/// <para>MouseMove内で呼ぶこと。</para>
		/// <para>表示するtooltipはSubItemのTagをstringにキャストする。</para>
		/// <para>ListView.ShowItemToolTipsはfalseであること。</para>
		/// </remarks>
		/// <param name="listview">対象のListView</param>
		/// <param name="tooltip">対象のToolTip</param>
		/// <param name="mouse_x">マウス位置 (listviewのクライアント座標)</param>
		/// <param name="mouse_y">マウス位置 (listviewのクライアント座標)</param>
		...
		/// <summary>
		/// 文字列をInt32に変換する。
		/// 失敗した場合はdefalt_valueを返す
		/// </summary>
		/// <param name="_from">変換対象の文字列</param>
		/// <param name="defalte_value">失敗時に返す値</param>
