...
//seainfonameimage.cs 
//GvoSeaInfo 
            AddRect(new Vector2(-5, -6), new Rectangle(0, 0, 60, 12 - 0));      //   0 ノルウェー海
            ...
            AddRect(new Vector2(-5, -6), new Rectangle(84, 0, 54, 12 - 0));        //  40 ベンガル湾
            ...
            AddRect(new Vector2(-5, -6), new Rectangle(180,   0,  42, 12)); //  82 パナマ湾
            AddRect(new Vector2(-5, -6), new Rectangle(168,  12,  82, 12)); //  83 ガラパゴス諸島沖
            AddRect(new Vector2(-5, -6), new Rectangle(180,  24,  62, 12)); //  84 グアヤキル湾
            AddRect(new Vector2(-5, -6), new Rectangle(180,  36,  62, 12)); //  85 東アジア西部
            AddRect(new Vector2(-5, -6), new Rectangle(180,  48,  62, 12)); //  86 東アジア東部
            AddRect(new Vector2(-5, -6), new Rectangle(180,  60,  72, 12)); //  87 北西太平洋海盆
            AddRect(new Vector2(-6, -6), new Rectangle(180,  72,  72, 12)); //  88 テラ・ノヴァ沖
            AddRect(new Vector2(-6, -6), new Rectangle(168,  84,  72, 12)); //  89 アイスランド海盆
            AddRect(new Vector2(-6, -6), new Rectangle(180,  96,  60, 12)); //  90 ラブラドル海
            AddRect(new Vector2(-6, -6), new Rectangle(180, 108,  42, 12)); //  91 ハワイ沖
            AddRect(new Vector2(-6, -6), new Rectangle(180, 120,  70, 12)); //  92 デンマーク海盆
            AddRect(new Vector2(-6, -6), new Rectangle(180, 132,  69, 12)); //  93 ノルウェー海盆
            AddRect(new Vector2(-6, -6), new Rectangle(180, 144,  70, 12)); //  94 北ノルウェー海
            AddRect(new Vector2(-6, -6), new Rectangle(180, 156,  52, 12)); //  95 フラム海峡
            AddRect(new Vector2(-6, -6), new Rectangle(180, 168,  81, 12)); //  96 ロフォーテン海盆
            AddRect(new Vector2(-6, -6), new Rectangle(180, 180,  63, 12)); //  97 西バレンツ海
            AddRect(new Vector2(-6, -6), new Rectangle(180, 192,  63, 12)); //  98 東バレンツ海
            AddRect(new Vector2(-6, -6), new Rectangle(180, 204,  21, 12)); //  99 白海
            ...
            AddRect(new Vector2(-6, -6), new Rectangle(180, 312,  71, 12)); // 107 西ベーリング海
            AddRect(new Vector2(-6, -6), new Rectangle(180, 336,  93, 12)); // 108 カムチャツカ半島沖
            AddRect(new Vector2(-6, -6), new Rectangle(180, 348,  61, 12)); // 109 オホーツク海
