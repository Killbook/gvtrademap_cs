...
namespace gvtrademap_cs
{
	...
	public static partial class def
	{
		...
		// 更新確認用
		static public int		VERSION						= 13000;
...
//		public const string		WINDOW_TITLE				= "大航海時代Online 交易MAP C# ver.1.22β1";
		public const string		WINDOW_TITLE				= "大航海時代Online 交易MAP C# ver.1.30";
		...
		public const string		INFO_PATH					= "cityinfo20\\";
		public const string		INFO_LOCAL_PATH				= "cityinfo_local\\";
		...
		// ファイル名(パス含む)
		public const string		WORLDINFO_FULLFNAME			= MAP_PATH + "worldmap.txt";
		...
		public const string		WEB_ICONS_FULLFNAME			= INFO_PATH + "webicons.txt";
