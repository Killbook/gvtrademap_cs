namespace gvtrademap_cs
{
	partial class gvtrademap_cs_form
	{
		...
		private void InitializeComponent()
		{
			...
			openpathToolStripMenuItem.Text = "大航海時代Onlineのフォルダを開く";
			// 
			...
			this.openpathmailToolStripMenuItem.Text = "メールフォルダを開く...";
			// 
			...
			this.openpathscreenshotToolStripMenuItem.Text = "スクリーンショットフォルダを開く...";
			// 
			// contextMenuStrip1
			// 
			...
			this.ToolStripMenuItem_country3.Text = "ネーデルランド";
			...
			this.openpathscreenshot2ToolStripMenuItem.Text = "航路図のスクリーンショットフォルダを開く...";
			// 
			...
			this.copy_name_to_clipboardToolStripMenuItem.Text = "名称をクリップボードにコピー";
