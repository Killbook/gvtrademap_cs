namespace gvtrademap_cs
{
	partial class find_form2
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolTip1.SetToolTip(this.comboBox1, "入力された文字列が含まれるものをできるだけ検索します\r\nxxxx,yyyy 形式で入力することで特定の座標をセンタリングすることができます");
			...
			this.toolTip1.SetToolTip(this.comboBox3, "・名称等\r\n　アイテムの名前、街名、使用言語から検索します。\r\n・種類\r\n　アイテムの種類から検索します。\r\n　例:食料品");
			...
			this.toolTip1.SetToolTip(this.comboBox2, "・街情報\r\n　街情報から検索します。\r\n　検索結果はスポット表示することができます。\r\n・アイテムデータベース\r\n　独自に保持しているアイテムデータベースから検索" +
