...
namespace gvo_base
{
  public class ShipPartsDataBase
  {
    ...
    {
      new EnumParser<ShipPartsDataBase.BuildShipType>(ShipPartsDataBase.BuildShipType.Small1, "小型1"),
      new EnumParser<ShipPartsDataBase.BuildShipType>(ShipPartsDataBase.BuildShipType.Small2, "小型2"),
      new EnumParser<ShipPartsDataBase.BuildShipType>(ShipPartsDataBase.BuildShipType.Middle, "中型"),
      new EnumParser<ShipPartsDataBase.BuildShipType>(ShipPartsDataBase.BuildShipType.Big1, "大型1"),
      new EnumParser<ShipPartsDataBase.BuildShipType>(ShipPartsDataBase.BuildShipType.Big2, "大型2")
    };
    ...
    {
      new EnumParser<ShipPartsDataBase.ShipSizeType>(ShipPartsDataBase.ShipSizeType.Small, "小型"),
      new EnumParser<ShipPartsDataBase.ShipSizeType>(ShipPartsDataBase.ShipSizeType.Middle, "中型"),
      new EnumParser<ShipPartsDataBase.ShipSizeType>(ShipPartsDataBase.ShipSizeType.Big, "大型"),
      new EnumParser<ShipPartsDataBase.ShipSizeType>(ShipPartsDataBase.ShipSizeType.All, "すべて"),
      new EnumParser<ShipPartsDataBase.ShipSizeType>(ShipPartsDataBase.ShipSizeType.MiddleAndBig, "中型、大型")
    };
    private static EnumParser<ShipPartsDataBase.PartsType>[] _partstype_enum_param = new EnumParser<ShipPartsDataBase.PartsType>[4]
    {
      new EnumParser<ShipPartsDataBase.PartsType>(ShipPartsDataBase.PartsType.Hull, "船体"),
      new EnumParser<ShipPartsDataBase.PartsType>(ShipPartsDataBase.PartsType.Sail, "帆"),
      new EnumParser<ShipPartsDataBase.PartsType>(ShipPartsDataBase.PartsType.Cannon, "大砲"),
      new EnumParser<ShipPartsDataBase.PartsType>(ShipPartsDataBase.PartsType.Other, "兵装")
    };
    ...
    {
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Hp, "耐久"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.VSail, "縦帆"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.HSail, "横帆"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Row, "漕船"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Turn, "旋回"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Wave, "対波"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Armor, "装甲"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Cabin, "船室"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.CannonRoom, "砲室"),
      new EnumParser<ShipPartsDataBase.BuildTargetType>(ShipPartsDataBase.BuildTargetType.Storage, "倉庫")
    };
    ...
    {
      return EnumParserUtility<ShipPartsDataBase.BuildTargetType>.ToString(ShipPartsDataBase._buildtargettype_enum_param, type, "不明");
    }
